...
// Slideshow
import { Swiper as SW } from '@uixkit.react/components/_plugins/_lib-slideshow.js';
...
export default class Swiper extends Component {
	...
	componentDidMount(){
		...
		__( document ).ready( function() {
			...
			__( '.uix-swiper' ).each( function( index, selectors )  {
				...
				if( actived === null ) {
					...
					if ( $el.find( '#app-slider1' ).length > 0 ) {
						const swiper2 = new SW('#app-slider2', {
							slidesPerView: 5,
							spaceBetween: 10,
							allowTouchMove: false
						});

						const swiper1 = new SW('#app-slider1', {
							slidesPerView: 1,
							spaceBetween: 10,
							speed: 1000,
							pagination: {
					...
					if ( $el.find( '#app-slider3' ).length > 0 ) {
						...
						const swiper3 = new SW('#app-slider3', {
							slidesPerView: 1,
							spaceBetween: 0,
							loop: false,
							speed: 1000,
					...
					if ( $el.find( '#app-slider4' ).length > 0 ) {
						const swiper4 = new SW('#app-slider4', {
							slidesPerView: 1,
							spaceBetween: 0,
							loop: false,
							speed: 1000,
					...
					if ( $el.find( '#app-slider5' ).length > 0 ) {
						const swiper5 = new SW('#app-slider5', {
							slidesPerView: 3,
							spaceBetween: 30,
							loop: true,
							speed: 1000,
					...
					if ( $el.find( '#app-slider6' ).length > 0 ) {
						const swiper6 = new SW('#app-slider6', {
					...
					if ( $el.find( '#app-slider7' ).length > 0 ) {
						...
						const swiper7 = new SW('#app-slider7', {
							slidesPerView: 1,
							spaceBetween: 0,
							loop: false,
							speed: 3500,
					...
					if ( $el.find( '#app-slider8' ).length > 0 ) {
						const swiper8 = new SW('#app-slider8', {
							spaceBetween: 10,
							grabCursor: false,
							loop: true,
							loopedSlides: 4,
						...
						/* thumbs */
						const swiper8Thumbs = new SW( '#app-slider8-thumbs', {
							spaceBetween: 10,
							centeredSlides: true,
					...
					if ( $el.find( '#app-slider9' ).length > 0 ) {
						const swiper9 = new SW('#app-slider9', {
							spaceBetween: 10,
							grabCursor: false,
							autoplay: {
								delay: 5000
						...
						__( '#app-slider9-triggers > div' ).off( 'click' ).on( 'click', function() {
