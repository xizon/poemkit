			...
			<div className="container">
				<div className="row">
					<div className="col-12">
						...
						<p>Form components are reusable elements that allow content creators and marketers to compose forms via the form builder. Each component represents a specific form field, such as a text box for user input, a group of radio buttons, etc.</p>
					</div>
				</div>
				{/*<!-- .row end -->*/}
