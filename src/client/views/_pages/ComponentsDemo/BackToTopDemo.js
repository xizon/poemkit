				...
				<div className="row">
					<div className="col-12">
						...
						<article className="uix-spacing--s" itemProp="text">
							<h4>Back To Top</h4>
							<div>
								<pre>import BackToTop from '@uixkit.react/components/BackToTop/index.tsx';</pre>
							</div>
							...
							<p className="mb-5">It accepts all props(include data-* attributes) which native div support. Scroll the page down to preview. The button is in the bottom right corner of the screen.</p>
