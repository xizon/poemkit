						...
						<div className="row">
							<div className="col-12">
								<h1 className="uix-t-c">
									Tabs Animated
									<a className="uix-typo--h3 align-middle" href="https://github.com/xizon/uix-kit-react/tree/main/src/client/components/TabsAnimated" target="_blank"><code><i className="fa fa-code" aria-hidden="true"></i></code></a>
								</h1>
							</div>
						</div>
						{/*<!-- .row end -->*/}
