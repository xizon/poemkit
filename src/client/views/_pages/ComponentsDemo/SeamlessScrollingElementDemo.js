			...
			<div className="container">
					<div className="row">
						<div className="col-12">
							...
							<div style={{position:"relative",zIndex:1,border:"1px solid #ddd",borderRadius:"8px",background:"#f9f9f9",width:"800px",maxWidth:"100%"}}>
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										<tr>
											...
											<td>number</td>
											<td>3000</td>
											<td>Speed of animation. Amount of time measured in milliseconds.</td>
										</tr>
										<tr>
											<td><code>gap</code></td>
											<td>number</td>
											<td>20</td>
											<td>The separation distance between each item in pixels.</td>
										</tr>
									</tbody>
								</table>
