				...
				<div className="row">
					<div className="col-12">
						...
						<article className="uix-spacing--s" itemProp="text">
							<h4>Navigation</h4>
							<div>
								<pre>import Navigation from '@uixkit.react/components/Navigation/index.tsx';</pre>
							</div>
