				...
				<div className="row">
					<div className="col-12">
						...
						<article className="uix-spacing--s" itemProp="text">
							...
							<div>
								<pre>import MultilevelDropdownMenu from '@uixkit.react/components/MultilevelDropdownMenu/index.tsx';</pre>
							</div>
