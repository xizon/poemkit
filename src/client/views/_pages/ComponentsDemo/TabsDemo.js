			...
			<div className="container">
				<div className="row">
					<div className="col-12">
						...
						<p>Tabbed interfaces are a way of navigating between multiple panels, reducing clutter and fitting more into a smaller space.</p>
					</div>
				</div>
				{/*<!-- .row end -->*/}
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										<tr>
											...
											<td>boolean</td>
											<td>false</td>
											<td>When true, the navigation button of the component is centered</td>
										</tr>
										<tr>
											<td><code>fullwidth</code></td>
											<td>boolean</td>
											<td>false</td>
											<td>When true, the navigation buttons of the component will be automatically filled in the 100% width area</td>
										</tr>
										<tr>
