							...
							<MousewheelInteraction 
								...
								refreshCallback={(res) => {
									if ( res.direction == 'down' ) {
										//scroll down
										console.log( 'down' );
										document.getElementById( 'app-demo' ).innerHTML = 'Direction: down';
									} else {
										//scroll up
										console.log( 'up' );
										document.getElementById( 'app-demo' ).innerHTML = 'Direction: up';
									}	
								}}
							/>

							<div className="alert alert-primary" id="app-demo">Status Here...</div>	
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										<tr>
											...
											<td>number</td>
											<td>500</td>
											<td>Set a interval to fix an issue for mousewheel event is too fast. Amount of time measured in milliseconds.</td>
										</tr>
										<tr>
											<td><code>actionTransitionDuration</code></td>
											<td>number</td>
											<td>1000</td>
											<td>The transition duration of each action. According to page transition animation changes. Amount of time measured in milliseconds.</td>
										</tr>
										<tr>
											<td><code>refreshCallback</code></td>
											<td>function | null</td>
											<td>-</td>
											<td>his function is called whenever the data is updated, including initialization. Exposes the JSON format data about the Mousewheel as an argument. You can use it like this: <code className="text-wrap">{`(res) => {if(res.direction=='down'){console.log('down');}else{console.log('up');}}`}</code></td>
										</tr>
									</tbody>
								</table>
