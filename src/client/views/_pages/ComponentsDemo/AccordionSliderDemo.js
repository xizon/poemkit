							...
							<div className="table-responsive-md">
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										...
										<tr>
											<td><code>boxAnimLeaveEv</code></td>
											<td>function</td>
											<td>-</td>
