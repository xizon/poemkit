			...
			<div className="container">
				<div className="row">
					<div className="col-12">
						...
						<p>This component create a list of arbitrary items that is the process of splitting information over multiple pages instead of showing it all on a single page.</p>
					</div>
				</div>
				{/*<!-- .row end -->*/}
