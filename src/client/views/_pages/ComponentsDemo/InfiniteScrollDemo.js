				...
				<div className="row">
					<div className="col-12">
						...
						<article className="uix-spacing--s" itemProp="text">
							...
							<div>
								<pre>import InfiniteScroll from '@uixkit.react/components/InfiniteScroll/index.tsx';</pre>
							</div>
    ...
    "data": [
        ...
        },
        {
            ...
            "avatar": "data:image/png;base64,"
								...
								<span>Page 2:</span>
								<pre><div style={{backgroundColor:"#f9f2f4",borderRadius:"3px",padding:"1rem",wordBreak:"normal",whiteSpace:"pre-wrap"}}>{`{
    "page": 2,
    "per_page": 3,
    "total": 5,
    "total_pages": 2,
