	  ...
	  <>
		...
		<section className="poemkit-spacing--s poemkit-spacing--no-bottom">
			<div className="container">
				<div className="row">
					<div className="col-12">
						<h3 className="app-header-title">For Page Loading</h3>
						<hr />
		...
		<section className="poemkit-spacing--s poemkit-spacing--no-bottom">
			<div className="container">
				<div className="row">
					<div className="col-12">
						<h3 className="app-header-title">For List</h3>
						<hr />
		...
		<section className="poemkit-spacing--s poemkit-spacing--no-bottom">
			<div className="container">
				<div className="row">
					<div className="col-12">
						<h3 className="app-header-title">For Content</h3>
						<hr />
		...
		<section className="poemkit-spacing--s poemkit-spacing--no-bottom">
			<div className="container">
				<div className="row">
					<div className="col-12">
						<h3 className="app-header-title">For Image</h3>
				...
				<div className="row">
					<div className="col-12">
						...
						<article className="poemkit-spacing--s" itemProp="text">
							...
							<div>
								<pre>import ContentPlaceholder from '@poemkit/components/ContentPlaceholder/index.tsx';</pre>
							</div>
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										<tr>
											...
											<td><code>page</code> | <code>list</code> | <code>content</code> | <code>image</code></td>
											<td>-</td>
											<td><strong>(Required)</strong> Placeholder display style</td>
										</tr>
									</tbody>
								</table>
