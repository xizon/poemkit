			...
			<div className="container">
				...
				<div className="row">
					<div className="col-12">
					    ...
					    <Rating name="app-rating-0" /><br />
						<Rating name="app-rating-1" stars={1} refreshCallback={ (newRating) => { console.log(`The new rating is: ${newRating}`) } } /> (contains callback function)<br />
						<Rating name="app-rating-2" stars={2} /><br />
						<Rating name="app-rating-3" stars={3} repeated={true} /> (can be selected multiple times)<br />
						<Rating name="app-rating-4" stars={4} repeated={true} /> (can be selected multiple times)<br />
						<Rating name="app-rating-5" stars={3} activeColor="blue" inactiveColor="#ddd" /> (custom colors)<br />
				...
				<div className="row">
					<div className="col-12">
						...
						<article className="poemkit-spacing--s" itemProp="text">
							<h4>Rating</h4>
							<div>
								<pre>import Rating from '@poemkit/components/Rating/index.tsx';</pre>
							</div>
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										...
										<tr>
											...
											<td>string</td>
											<td>#ff851b</td>
											<td>Active color for shape</td>
										</tr>
										<tr>
											<td><code>inactiveColor</code></td>
											<td>string</td>
											<td>#333</td>
											<td>Inactive color for shape</td>
										</tr>
										<tr>
											<td><code>repeated</code></td>
											<td>boolean</td>
											<td>false</td>
											<td>When true, do not allow repeated selection</td>
										</tr>
										<tr>
											<td><code>stars</code></td>
											<td>number</td>
											<td>0</td>
											<td>Specify a rating number, an integer <code>0</code> to <code>5</code></td>
										</tr>
										<tr>
											<td><code>refreshCallback</code></td>
											<td>function | null</td>
											<td>-</td>
											<td>This function is called whenever the data is updated. Exposes the JSON format data about the page number as an argument.</td>
										</tr>
									</tbody>
								</table>
