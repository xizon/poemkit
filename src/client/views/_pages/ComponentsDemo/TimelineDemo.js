			...
			<div className="container">
				<div className="row">
					<div className="col-12">
						...
						<p>This component is used to create a horizontal or vertical timeline layout. It supports an adjustable time range to change the view for zooming in or out.</p>
					</div>
				</div>
				{/*<!-- .row end -->*/}
								...
								<table className="table table-bordered table-striped mb-5">
									...
									<tbody>
										<tr>
											...
											<td>boolean</td>
											<td>false</td>
											<td>When true, the click event will be used to control the display effect of the timeline.</td>
										</tr>
										<tr>
