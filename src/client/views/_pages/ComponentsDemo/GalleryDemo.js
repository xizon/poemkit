				...
				<div className="row">
					<div className="col-12">
						...
						<article className="uix-spacing--s" itemProp="text">
							<h4>Gallery</h4>
							<div>
								<pre>import Gallery from '@uixkit.react/components/Gallery/index.tsx';</pre>
							</div>
